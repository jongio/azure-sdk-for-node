...
class IotHubProperties {
   ...
   * @property {array} [authorizationPolicies] The shared access policies you
   ...
   * @property {string} [state] The hub state.
   * @property {string} [hostName] The name of the host.
   * @property {object} [eventHubEndpoints] The Event Hub-compatible endpoint
   * properties. The only possible keys to this dictionary is events. This key
   * has to be present in the dictionary while making create or update calls
   * for the IoT hub.
   ...
   * @property {array} [routing.endpoints.storageContainers] The list of
   ...
   * @property {object} [routing.fallbackRoute] The properties of the route
   * that is used as a fall-back route when none of the conditions specified in
   * the 'routes' section are met. This is an optional parameter. When this
   ...
   * @property {string} [routing.fallbackRoute.condition] The condition which
   * is evaluated in order to apply the fallback route. If the condition is not
   ...
   * @property {array} [routing.enrichments] The list of user-provided
   ...
   * @property {moment.duration} [cloudToDevice.defaultTtlAsIso8601] The
   ...
   * https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-messaging#cloud-to-device-messages.
   * @property {moment.duration} [cloudToDevice.feedback.ttlAsIso8601] The
   ...
   * @property {object} [deviceStreams] The device streams properties of
   * iothub.
   * @property {array} [deviceStreams.streamingEndpoints] List of Device
   * Streams Endpoints.
   * @property {string} [features] The capabilities and features enabled for
   * the IoT hub. Possible values include: 'None', 'DeviceManagement'
   */
  constructor() {
  }
