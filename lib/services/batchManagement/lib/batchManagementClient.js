...
/** Class representing a BatchManagementClient. */
class BatchManagementClient extends ServiceClient {
  /**
...
module.exports = BatchManagementClient;
module.exports['default'] = BatchManagementClient;
module.exports.BatchManagementClient = BatchManagementClient;
module.exports.BatchManagementModels = models;
