 ...
 */
function _getByBillingProfileName(billingAccountName, billingProfileName, options, callback) {
...
class Policies {
   ...
   */
  getByBillingProfileNameWithHttpOperationResponse(billingAccountName, billingProfileName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._getByBillingProfileName(billingAccountName, billingProfileName, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  getByBillingProfileName(billingAccountName, billingProfileName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._getByBillingProfileName(billingAccountName, billingProfileName, options, optionalCallback);
    }
  }
