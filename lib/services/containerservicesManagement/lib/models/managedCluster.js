...
class ManagedCluster extends models['Resource'] {
   ...
   * @property {number} [maxAgentPools] The max number of agent pools for the
   * managed cluster.
   ...
   * @property {string} [networkProfile.loadBalancerSku] The load balancer sku
   * for the managed cluster. Possible values include: 'standard', 'basic'
   ...
   * @property {object} [identity] The identity of the managed cluster, if
   * configured.
   * @property {string} [identity.principalId] The principal id of the system
   * assigned identity which is used by master components.
