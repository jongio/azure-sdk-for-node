...
function _getUpgradeProfile(resourceGroupName, resourceName, options, callback) {
  ...
  try {
    ...
    if (resourceName !== null && resourceName !== undefined) {
      ...
      {
        throw new Error('"resourceName" should satisfy the constraint - "MaxLength": 63');
      }
      if (resourceName.length < 1)
      {
        throw new Error('"resourceName" should satisfy the constraint - "MinLength": 1');
      }
      if (resourceName.match(/^[a-zA-Z0-9]$|^[a-zA-Z0-9][-_a-zA-Z0-9]{0,61}[a-zA-Z0-9]$/) === null)
      {
        throw new Error('"resourceName" should satisfy the constraint - "Pattern": /^[a-zA-Z0-9]$|^[a-zA-Z0-9][-_a-zA-Z0-9]{0,61}[a-zA-Z0-9]$/');
      }
    }
    if (this.client.acceptLanguage !== null && this.client.acceptLanguage !== undefined && typeof this.client.acceptLanguage.valueOf() !== 'string') {
      throw new Error('this.client.acceptLanguage must be of type string.');
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listClusterAdminCredentials(resourceGroupName, resourceName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/listClusterAdminCredential';
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{resourceName}', encodeURIComponent(resourceName));
  let queryParameters = [];
  ...
  return client.pipeline(httpRequest, (err, response, responseBody) => {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['CredentialResults']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        let deserializationError = new Error(`Error ${error} occurred in deserializing the responseBody - ${responseBody}`);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _listClusterUserCredentials(resourceGroupName, resourceName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/listClusterUserCredential';
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{resourceName}', encodeURIComponent(resourceName));
  let queryParameters = [];
 ...
 * add-on.
 *
 * @param {string} [parameters.nodeResourceGroup] Name of the resource group
 ...
 *
 * @param {string} [parameters.networkProfile.loadBalancerSku] The load
 * balancer sku for the managed cluster. Possible values include: 'standard',
 * 'basic'
 *
 ...
 *
 * @param {object} [parameters.identity] The identity of the managed cluster,
 * if configured.
 *
 ...
 * identity in master components and an auto-created user assigned identity in
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _resetServicePrincipalProfile(resourceGroupName, resourceName, parameters, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Send request
  this.beginResetServicePrincipalProfile(resourceGroupName, resourceName, parameters, options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _resetAADProfile(resourceGroupName, resourceName, parameters, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Send request
  this.beginResetAADProfile(resourceGroupName, resourceName, parameters, options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
...
function _beginResetServicePrincipalProfile(resourceGroupName, resourceName, parameters, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/resetServicePrincipalProfile';
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{resourceName}', encodeURIComponent(resourceName));
  let queryParameters = [];
  ...
  try {
    if (parameters !== null && parameters !== undefined) {
      let requestModelMapper = new client.models['ManagedClusterServicePrincipalProfile']().mapper();
      requestModel = client.serialize(requestModelMapper, parameters, 'parameters');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
...
function _beginResetAADProfile(resourceGroupName, resourceName, parameters, options, callback) {
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ContainerService/managedClusters/{resourceName}/resetAADProfile';
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{resourceName}', encodeURIComponent(resourceName));
  let queryParameters = [];
  ...
  try {
    if (parameters !== null && parameters !== undefined) {
      let requestModelMapper = new client.models['ManagedClusterAADProfile']().mapper();
      requestModel = client.serialize(requestModelMapper, parameters, 'parameters');
      requestContent = JSON.stringify(requestModel);
    }
  } catch (error) {
...
class ManagedClusters {
  ...
  constructor(client) {
    ...
    this._listClusterAdminCredentials = _listClusterAdminCredentials;
    this._listClusterUserCredentials = _listClusterUserCredentials;
    this._get = _get;
    this._createOrUpdate = _createOrUpdate;
    this._updateTags = _updateTags;
    this._deleteMethod = _deleteMethod;
    this._resetServicePrincipalProfile = _resetServicePrincipalProfile;
    this._resetAADProfile = _resetAADProfile;
    ...
    this._beginResetServicePrincipalProfile = _beginResetServicePrincipalProfile;
    this._beginResetAADProfile = _beginResetAADProfile;
   ...
   * @reject {Error} - The error object.
   */
  listClusterAdminCredentialsWithHttpOperationResponse(resourceGroupName, resourceName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listClusterAdminCredentials(resourceGroupName, resourceName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listClusterAdminCredentials(resourceGroupName, resourceName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listClusterAdminCredentials(resourceGroupName, resourceName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  listClusterUserCredentialsWithHttpOperationResponse(resourceGroupName, resourceName, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._listClusterUserCredentials(resourceGroupName, resourceName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  listClusterUserCredentials(resourceGroupName, resourceName, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._listClusterUserCredentials(resourceGroupName, resourceName, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  resetServicePrincipalProfileWithHttpOperationResponse(resourceGroupName, resourceName, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._resetServicePrincipalProfile(resourceGroupName, resourceName, parameters, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  resetServicePrincipalProfile(resourceGroupName, resourceName, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._resetServicePrincipalProfile(resourceGroupName, resourceName, parameters, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  resetAADProfileWithHttpOperationResponse(resourceGroupName, resourceName, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._resetAADProfile(resourceGroupName, resourceName, parameters, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  resetAADProfile(resourceGroupName, resourceName, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._resetAADProfile(resourceGroupName, resourceName, parameters, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginResetServicePrincipalProfileWithHttpOperationResponse(resourceGroupName, resourceName, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginResetServicePrincipalProfile(resourceGroupName, resourceName, parameters, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginResetServicePrincipalProfile(resourceGroupName, resourceName, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginResetServicePrincipalProfile(resourceGroupName, resourceName, parameters, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  beginResetAADProfileWithHttpOperationResponse(resourceGroupName, resourceName, parameters, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginResetAADProfile(resourceGroupName, resourceName, parameters, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  beginResetAADProfile(resourceGroupName, resourceName, parameters, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginResetAADProfile(resourceGroupName, resourceName, parameters, options, optionalCallback);
    }
  }
