...
/**
 * Class representing a SalesQuote.
 */
class SalesQuote {
  /**
   * Create a SalesQuote.
   * @property {uuid} [id] The id property for the salesQuote entity
   * @property {string} [number] The number property for the salesQuote entity
   * @property {string} [externalDocumentNumber] The externalDocumentNumber
   * property for the salesQuote entity
   * @property {date} [documentDate] The documentDate property for the
   * salesQuote entity
   * @property {date} [dueDate] The dueDate property for the salesQuote entity
   * @property {uuid} [customerId] The customerId property for the salesQuote
   * entity
   * @property {string} [contactId] The contactId property for the salesQuote
   * entity
   ...
   * salesQuote entity
   * @property {string} [billToName] The billToName property for the salesQuote
   * entity
   ...
   * property for the salesQuote entity
   * @property {string} [shipToName] The shipToName property for the salesQuote
   * entity
   ...
   * @property {uuid} [currencyId] The currencyId property for the salesQuote
   * entity
   ...
   * property for the salesQuote entity
   * @property {string} [status] The status property for the salesQuote entity
   * @property {date} [sentDate] The sentDate property for the salesQuote
   * entity
   * @property {date} [validUntilDate] The validUntilDate property for the
   * salesQuote entity
   * @property {date} [acceptedDate] The acceptedDate property for the
   * salesQuote entity
   ...
   * salesQuote entity
   * @property {string} [email] The email property for the salesQuote entity
  ...
  /**
   * Defines the metadata of SalesQuote
   *
   * @returns {object} metadata of SalesQuote
   *
   */
  mapper() {
    return {
