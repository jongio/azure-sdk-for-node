...
/**
 * Class representing a SalesCreditMemo.
 */
class SalesCreditMemo {
  /**
   * Create a SalesCreditMemo.
  ...
  /**
   * Defines the metadata of SalesCreditMemo
   *
   * @returns {object} metadata of SalesCreditMemo
   *
   */
  mapper() {
    return {
...
module.exports = SalesCreditMemo;
