...
/** Class representing a HanaManagementClient. */
class HanaManagementClient extends ServiceClient {
  /**
   * Create a HanaManagementClient.
...
module.exports = HanaManagementClient;
module.exports['default'] = HanaManagementClient;
module.exports.HanaManagementClient = HanaManagementClient;
module.exports.HanaManagementModels = models;
