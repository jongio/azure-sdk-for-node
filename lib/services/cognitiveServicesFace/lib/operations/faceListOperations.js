    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['FaceList']().mapper();
        ...
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = {
            ...
            type: {
              ...
              element: {
                  required: false,
                  serializedName: 'FaceListElementType',
                  type: {
                    name: 'Composite',
                    className: 'FaceList'
                  }
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _addFaceFromUrl(faceListId, url, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _addFaceFromStream(faceListId, image, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
...
class FaceListOperations {
   ...
   * @reject {Error} - The error object.
   */
  addFaceFromUrlWithHttpOperationResponse(faceListId, url, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._addFaceFromUrl(faceListId, url, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  addFaceFromUrl(faceListId, url, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._addFaceFromUrl(faceListId, url, options, optionalCallback);
    }
  }
   ...
   * @reject {Error} - The error object.
   */
  addFaceFromStreamWithHttpOperationResponse(faceListId, image, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._addFaceFromStream(faceListId, image, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  addFaceFromStream(faceListId, image, options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._addFaceFromStream(faceListId, image, options, optionalCallback);
    }
  }

}

module.exports = FaceListOperations;
