...
export default class CdnManagementClientDONTMERGE extends AzureServiceClient {
  /**
   * Initializes a new instance of the CdnManagementClientDONTMERGE class.
   * @constructor
   *
   * @class
...
export { CdnManagementClientDONTMERGE, models as CdnManagementClientDONTMERGEModels };
