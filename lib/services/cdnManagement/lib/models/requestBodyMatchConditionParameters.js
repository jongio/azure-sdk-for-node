...
class RequestBodyMatchConditionParameters {
  /**
   * Create a RequestBodyMatchConditionParameters.
  ...
  /**
   * Defines the metadata of RequestBodyMatchConditionParameters
   *
   * @returns {object} metadata of RequestBodyMatchConditionParameters
   *
   */
  mapper() {
    return {
...
module.exports = RequestBodyMatchConditionParameters;
