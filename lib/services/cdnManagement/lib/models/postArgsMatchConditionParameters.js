...
class PostArgsMatchConditionParameters {
  /**
   * Create a PostArgsMatchConditionParameters.
   * @property {string} selector Name of PostArg to be matched
  ...
  /**
   * Defines the metadata of PostArgsMatchConditionParameters
   *
   * @returns {object} metadata of PostArgsMatchConditionParameters
   *
   */
  mapper() {
    return {
...
module.exports = PostArgsMatchConditionParameters;
