 ...
 */
class DeliveryRuleIsDeviceCondition extends models['DeliveryRuleCondition'] {
  /**
   * Create a DeliveryRuleIsDeviceCondition.
  ...
  /**
   * Defines the metadata of DeliveryRuleIsDeviceCondition
   *
   * @returns {object} metadata of DeliveryRuleIsDeviceCondition
   *
   */
  mapper() {
    return {
...
module.exports = DeliveryRuleIsDeviceCondition;
