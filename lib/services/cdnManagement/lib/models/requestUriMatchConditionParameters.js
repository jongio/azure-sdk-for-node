...
class RequestUriMatchConditionParameters {
  /**
   * Create a RequestUriMatchConditionParameters.
  ...
  /**
   * Defines the metadata of RequestUriMatchConditionParameters
   *
   * @returns {object} metadata of RequestUriMatchConditionParameters
   *
   */
  mapper() {
    return {
...
module.exports = RequestUriMatchConditionParameters;
