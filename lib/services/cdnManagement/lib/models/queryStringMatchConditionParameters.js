...
class QueryStringMatchConditionParameters {
  /**
   * Create a QueryStringMatchConditionParameters.
  ...
  /**
   * Defines the metadata of QueryStringMatchConditionParameters
   *
   * @returns {object} metadata of QueryStringMatchConditionParameters
   *
   */
  mapper() {
    return {
...
module.exports = QueryStringMatchConditionParameters;
