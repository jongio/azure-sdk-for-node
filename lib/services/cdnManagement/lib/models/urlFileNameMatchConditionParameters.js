...
class UrlFileNameMatchConditionParameters {
  /**
   * Create a UrlFileNameMatchConditionParameters.
  ...
  /**
   * Defines the metadata of UrlFileNameMatchConditionParameters
   *
   * @returns {object} metadata of UrlFileNameMatchConditionParameters
   *
   */
  mapper() {
    return {
...
module.exports = UrlFileNameMatchConditionParameters;
