 ...
 */
class DeliveryRuleUrlFileNameCondition extends models['DeliveryRuleCondition'] {
  /**
   * Create a DeliveryRuleUrlFileNameCondition.
  ...
  /**
   * Defines the metadata of DeliveryRuleUrlFileNameCondition
   *
   * @returns {object} metadata of DeliveryRuleUrlFileNameCondition
   *
   */
  mapper() {
    return {
...
module.exports = DeliveryRuleUrlFileNameCondition;
