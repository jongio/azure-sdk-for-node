 ...
 */
class DeliveryRuleQueryStringCondition extends models['DeliveryRuleCondition'] {
  /**
   * Create a DeliveryRuleQueryStringCondition.
  ...
  /**
   * Defines the metadata of DeliveryRuleQueryStringCondition
   *
   * @returns {object} metadata of DeliveryRuleQueryStringCondition
   *
   */
  mapper() {
    return {
...
module.exports = DeliveryRuleQueryStringCondition;
