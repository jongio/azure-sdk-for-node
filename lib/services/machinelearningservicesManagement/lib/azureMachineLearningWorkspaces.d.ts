...
export default class AzureMachineLearningWorkspaces extends AzureServiceClient {
  /**
...
export { AzureMachineLearningWorkspaces, models as AzureMachineLearningWorkspacesModels };
