 ...
 * instance of the AzureMachineLearningWorkspaces.
 */
export interface UsagesByVMFamily {


    /**
     * Gets the current usage information in a detailed format as well as limits
     * for Batch AI resources for given subscription, by VM family, workspace and
     * cluster hierarchy.
     *
     * @param {string} location The location for which resource usage is queried.
     *
     ...
     * @returns {Promise} A promise is returned
     *
     * @resolve {HttpOperationResponse<ListUsagesByVMFamilyResult>} - The deserialized result object.
     *
     * @reject {Error|ServiceError} - The error object.
     */
    listWithHttpOperationResponse(location: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.ListUsagesByVMFamilyResult>>;
     ...
     * {Promise} A promise is returned.
     *
     *                      @resolve {ListUsagesByVMFamilyResult} - The deserialized result object.
     *
     *                      @reject {Error|ServiceError} - The error object.
     *
     * {ServiceCallback} optionalCallback(err, result, request, response)
     ...
     *                      {Error|ServiceError}  err        - The Error object if an error occurred, null otherwise.
     *
     *                      {ListUsagesByVMFamilyResult} [result]   - The deserialized result object if an error did not occur.
     *                      See {@link ListUsagesByVMFamilyResult} for more
     *                      information.
     *
     *                      {WebResource} [request]  - The HTTP Request object if an error did not occur.
     *
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    list(location: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.ListUsagesByVMFamilyResult>;
    list(location: string, callback: ServiceCallback<models.ListUsagesByVMFamilyResult>): void;
    list(location: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.ListUsagesByVMFamilyResult>): void;
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    listNextWithHttpOperationResponse(nextPageLink: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.ListUsagesByVMFamilyResult>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    listNext(nextPageLink: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.ListUsagesByVMFamilyResult>;
    listNext(nextPageLink: string, callback: ServiceCallback<models.ListUsagesByVMFamilyResult>): void;
    listNext(nextPageLink: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.ListUsagesByVMFamilyResult>): void;
}
