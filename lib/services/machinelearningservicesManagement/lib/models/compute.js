...
class Compute {
   ...
   * compute.
   * @property {date} [createdOn] The date and time when the compute was
   * created.
   * @property {date} [modifiedOn] The date and time when the compute was last
   * modified.
   * @property {string} [resourceId] ARM resource id of the underlying compute
   * @property {array} [provisioningErrors] Errors during provisioning
   * @property {boolean} [isAttachedCompute] Indicating whether the compute was
