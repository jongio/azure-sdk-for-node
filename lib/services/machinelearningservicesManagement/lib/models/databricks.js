 ...
 */
class Databricks extends models['Compute'] {
  /**
   * Create a Databricks.
   * @property {object} [properties]
   * @property {string} [properties.databricksAccessToken] Databricks access
   * token
   */
  constructor() {
    super();
  ...
  /**
   * Defines the metadata of Databricks
   *
   * @returns {object} metadata of Databricks
   *
   */
  mapper() {
    return {
