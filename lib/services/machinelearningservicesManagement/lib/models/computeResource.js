...
class ComputeResource extends models['Resource'] {
   ...
   * @property {string} [properties.resourceId] ARM resource id of the
   * underlying compute
   * @property {array} [properties.provisioningErrors] Errors during
   * provisioning
   * @property {boolean} [properties.isAttachedCompute] Indicating whether the
   * compute was provisioned by user and brought from outside if true, or
