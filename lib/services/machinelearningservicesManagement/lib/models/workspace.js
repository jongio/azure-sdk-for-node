...
class Workspace extends models['Resource'] {
   ...
   * @property {string} [applicationInsights] ARM id of the application
   ...
   * has been created
   * @property {string} [storageAccount] ARM id of the storage account
   * associated with this workspace. This cannot be changed once the workspace
   * has been created
   * @property {string} [discoveryUrl] Url for the discovery service to
