...
export interface ProvisioningError {
   ...
   * 'BadPIRSource', 'BadISOSource', 'BadManagedImageSource', 'BadSharedImageVersionSource',
   * 'BadCustomizerType', 'UnsupportedCustomizerType', 'NoCustomizerScript', 'BadDistributeType',
...
export interface ImageTemplate extends Resource {
  ...
  */
  ...
  /**
   * Maximum duration to wait while building the image template. Default is 60 minutes.
  */
...
export interface ImageTemplateFileCustomizer extends ImageTemplateCustomizer {
  ...
  */
  sourceUri?: string;
  /**
   * The absolute path (with existing directory structure) where the file will be uploaded to in
   * the VM
  */
  destination?: string;
}
