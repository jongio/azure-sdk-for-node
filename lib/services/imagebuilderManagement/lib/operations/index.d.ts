...
export interface VirtualMachineImageTemplates {
     ...
     * @reject {Error|ServiceError} - The error object.
     */
    beginUpdateWithHttpOperationResponse(parameters: models.ImageTemplateUpdateParameters, resourceGroupName: string, imageTemplateName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<HttpOperationResponse<models.ImageTemplate>>;
     ...
     *                      {http.IncomingMessage} [response] - The HTTP Response stream if an error did not occur.
     */
    beginUpdate(parameters: models.ImageTemplateUpdateParameters, resourceGroupName: string, imageTemplateName: string, options?: { customHeaders? : { [headerName: string]: string; } }): Promise<models.ImageTemplate>;
    beginUpdate(parameters: models.ImageTemplateUpdateParameters, resourceGroupName: string, imageTemplateName: string, callback: ServiceCallback<models.ImageTemplate>): void;
    beginUpdate(parameters: models.ImageTemplateUpdateParameters, resourceGroupName: string, imageTemplateName: string, options: { customHeaders? : { [headerName: string]: string; } }, callback: ServiceCallback<models.ImageTemplate>): void;
