 ...
 */
class GremlinGraph extends models['Resource'] {
  /**
   * Create a GremlinGraph.
   * @property {string} gremlinGraphId Name of the Cosmos DB Gremlin graph
  ...
  /**
   * Defines the metadata of GremlinGraph
   *
   * @returns {object} metadata of GremlinGraph
   *
   */
  mapper() {
    return {
