...
class ContainerCreateUpdateParameters {
  /**
   * Create a ContainerCreateUpdateParameters.
   * @property {object} resource The standard JSON format of a container
   * @property {string} [resource.id] Name of the Cosmos DB container
  ...
  /**
   * Defines the metadata of ContainerCreateUpdateParameters
   *
   * @returns {object} metadata of ContainerCreateUpdateParameters
   *
   */
  mapper() {
    return {
      required: false,
      serializedName: 'ContainerCreateUpdateParameters',
      type: {
        name: 'Composite',
        className: 'ContainerCreateUpdateParameters',
        modelProperties: {
          resource: {
            required: true,
...
module.exports = ContainerCreateUpdateParameters;
