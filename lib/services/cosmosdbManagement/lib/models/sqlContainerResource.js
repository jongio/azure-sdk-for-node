...
class SqlContainerResource {
  /**
   * Create a SqlContainerResource.
   * @property {string} id Name of the Cosmos DB SQL container
  ...
  /**
   * Defines the metadata of SqlContainerResource
   *
   * @returns {object} metadata of SqlContainerResource
   *
   */
  mapper() {
    return {
...
module.exports = SqlContainerResource;
