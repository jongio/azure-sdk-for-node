...
class CassandraKeyspaceCreateUpdateParameters {
  /**
   * Create a CassandraKeyspaceCreateUpdateParameters.
   * @property {object} resource The standard JSON format of a Cassandra
   * keyspace
   * @property {string} [resource.id] Name of the Cosmos DB Cassandra keyspace
  ...
  /**
   * Defines the metadata of CassandraKeyspaceCreateUpdateParameters
   *
   * @returns {object} metadata of CassandraKeyspaceCreateUpdateParameters
   *
   */
  mapper() {
    return {
...
module.exports = CassandraKeyspaceCreateUpdateParameters;
