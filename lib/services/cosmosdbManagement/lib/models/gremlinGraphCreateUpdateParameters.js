...
class GremlinGraphCreateUpdateParameters {
  /**
   * Create a GremlinGraphCreateUpdateParameters.
   * @property {object} resource The standard JSON format of a Gremlin graph
   * @property {string} [resource.id] Name of the Cosmos DB Gremlin graph
  ...
  /**
   * Defines the metadata of GremlinGraphCreateUpdateParameters
   *
   * @returns {object} metadata of GremlinGraphCreateUpdateParameters
   *
   */
  mapper() {
    return {
...
module.exports = GremlinGraphCreateUpdateParameters;
