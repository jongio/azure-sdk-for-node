 ...
 */
function _get(resourceGroupName, locationName, workflowId, operationId, options, callback) {
  ...
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.StorageSync/locations/{locationName}/workflows/{workflowId}/operations/{operationId}';
...
class OperationStatusOperations {
   ...
   */
  getWithHttpOperationResponse(resourceGroupName, locationName, workflowId, operationId, options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._get(resourceGroupName, locationName, workflowId, operationId, options, (err, result, request, response) => {
   ...
   *                      {stream} [response] - The HTTP Response stream if an error did not occur.
   */
  get(resourceGroupName, locationName, workflowId, operationId, options, optionalCallback) {
    let client = this.client;
    let self = this;
    ...
    if (!optionalCallback) {
      ...
      return self._get(resourceGroupName, locationName, workflowId, operationId, options, optionalCallback);
    }
  }

}

module.exports = OperationStatusOperations;
